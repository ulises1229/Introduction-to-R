...
| Día 5      | Modelos de efectos mixtos y aplicaciones | <ul> <li> </li> </ul> |  <ol><li>[Presentación](pdf/dia5.pdf)</li><li>[Código](code/dia5.R)</li><li>[sleep.csv](datos/sleep.csv)</li><li>[rail.csv](datos/rail.csv)</li></ol>   | |
